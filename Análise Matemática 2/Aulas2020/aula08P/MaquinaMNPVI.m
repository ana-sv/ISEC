...
% Last Modified by GUIDE v2.5 16-Apr-2020 15:43:15
...
TesteF=MException('MATLAB:MyAtualizar:badF','Introduza uma função em t e y');
TesteNR=MException('MATLAB:MyAtualizar:badNR','Introduza um número real');
%outras
