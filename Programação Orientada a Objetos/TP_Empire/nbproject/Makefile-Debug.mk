...
${OBJECTDIR}/Abandonado.o: Abandonado.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Abandonado.o Abandonado.cpp

${OBJECTDIR}/Alianca.o: Alianca.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Alianca.o Alianca.cpp

${OBJECTDIR}/BancoCentral.o: BancoCentral.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BancoCentral.o BancoCentral.cpp

${OBJECTDIR}/BolsaValores.o: BolsaValores.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BolsaValores.o BolsaValores.cpp
...
${OBJECTDIR}/DefesasTerritoriais.o: DefesasTerritoriais.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DefesasTerritoriais.o DefesasTerritoriais.cpp

${OBJECTDIR}/DronesMilitares.o: DronesMilitares.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DronesMilitares.o DronesMilitares.cpp
...
${OBJECTDIR}/Invasao.o: Invasao.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Invasao.o Invasao.cpp
...
${OBJECTDIR}/MisseisTeleguiados.o: MisseisTeleguiados.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MisseisTeleguiados.o MisseisTeleguiados.cpp
...
${OBJECTDIR}/Snapshot.o: Snapshot.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Snapshot.o Snapshot.cpp
