...
public:
    ...
    string getNome()const; // const para poder aceder ao nome que é privado     
    long getBi()const;
    long getNif()const;

    void getInfoPessoa(ostringstream &oss)const; // usamos const para imprimir tudo para evitar o uso das funções getNome, getBi ....
